...
/**
      ...
      >
        <div slot="heading">
          <ha-dialog-header>
            ...
            ></ha-icon-button>
            <span slot="title">
              ${Ni("ui.dialog.entity_picker.title",this.hass)}
            </span>
          </ha-dialog-header>
        ...
        >
          ...
          <div slot="meta" class="meta">
            <ha-button
              ...
              size="small"
            >
              ${(null===(a=this._params)||void 0===a?void 0:a.domains.includes(o))||e[i].entities.every(e=>{var t;return null===(t=this._params)||void 0===t?void 0:t.entities.includes(e.key)})?Zi("ui.components.media-browser.file_management.deselect_all",this.hass):Zi("ui.components.subpage-data-table.select_all",this.hass)}
            </ha-button>
            <ha-icon-button .path="${zs}" @click=${e=>{e.target.blur()}} class="chevron"></ha-icon-button>
          </div>
          <span>${e[i].name}</span>
          <span slot="secondary">${Ni("ui.panel.card_editor.fields.entities.included_number",this.hass,["{number}","{total}"],[l,r.length])}</span>
        </mwc-list-item>
    ...
    `}};t([de({attribute:!1})],Gs.prototype,"hass",void 0),t([ce()],Gs.prototype,"_params",void 0),t([ce()],Gs.prototype,"_search",void 0),t([ce()],Gs.prototype,"_filter",void 0),t([ce()],Gs.prototype,"_width",void 0),t([ce()],Gs.prototype,"_height",void 0),t([ce()],Gs.prototype,"expandedGroups",void 0),t([ce()],Gs.prototype,"options",void 0),t([ce()],Gs.prototype,"scheduleEntities",void 0),Gs=t([re("dialog-select-entities")],Gs);var Js=Object.freeze({__proto__:null,get DialogSelectEntities(){return Gs}});let Ys=class extends oe{constructor(){super(...arguments),this.active=!1}render(){return q`
    ...
    `}};t([de({attribute:!1})],Ys.prototype,"hass",void 0),t([de({type:String})],Ys.prototype,"icon",void 0),t([de({type:Boolean})],Ys.prototype,"useStateIcon",void 0),t([de({type:Boolean})],Ys.prototype,"selectable",void 0),t([de({type:Boolean})],Ys.prototype,"removable",void 0),t([de({type:Boolean})],Ys.prototype,"toggleable",void 0),t([de({type:Boolean})],Ys.prototype,"active",void 0),t([de({type:String})],Ys.prototype,"badge",void 0),t([de({type:String})],Ys.prototype,"value",void 0),t([de({type:Boolean})],Ys.prototype,"disabled",void 0),Ys=t([re("scheduler-chip")],Ys);let Qs=class extends oe{constructor(){super(...arguments),this.value=[]}render(){return this.items?q`
    ...
    `}};t([de({attribute:!1})],Qs.prototype,"hass",void 0),t([de({attribute:!1})],Qs.prototype,"items",void 0),t([de({attribute:!1})],Qs.prototype,"value",void 0),t([de({type:Boolean})],Qs.prototype,"selectable",void 0),t([de({type:Boolean})],Qs.prototype,"toggleable",void 0),t([de({type:Boolean})],Qs.prototype,"removable",void 0),t([de({type:Boolean})],Qs.prototype,"disabled",void 0),Qs=t([re("scheduler-chip-set")],Qs);let Xs=class extends oe{constructor(){super(...arguments),this.autofocus=!1,this.disabled=!1,this.hideClearIcon=!1,this._opened=!1,this._isOpening=!1,this._items=[],this._getItems=()=>{const e=(this.getItems?this.getItems():[]).sort((e,t)=>Bi(e.primary,t.primary));return e.length||e.push({id:"___no_matching_items_found___",primary:Ni("ui.dialog.entity_picker.no_results",this.hass),icon:"mdi:cancel"}),e}}shouldUpdate(e){return!!(e.has("value")||e.has("label")||e.has("disabled"))||!(!e.has("_opened")&&this._opened)}willUpdate(e){e.has("_opened")&&this._opened&&(this._items=this._getItems())}render(){const e=!!this.value&&!this.disabled&&!this.hideClearIcon;return q`
          ...
          >
            ${this.value?this.valueRenderer?this.valueRenderer(this.value):q`<span slot="headline">${this.value}</span>`:q`
              <span slot="headline" class="placeholder">
                ${this.placeholder||Ni("ui.dialog.entity_picker.choose",this.hass)}
              </span>
            `}
            ${e?q`
                <ha-icon-button
    ...
    `}get _value(){return this.value||""}_renderHelper(){return this.helper?q`<ha-input-helper-text .disabled=${this.disabled}
        ...
        >`:V}_valueChanged(e){var t;e.stopPropagation(),this._comboBox.setTextFieldValue("");const i=null===(t=e.detail.value)||void 0===t?void 0:t.trim();"___no_matching_items_found___"!==i&&(this._items.find(e=>e.id==i)||this.allowCustomValue)&&i!==this._value&&this._setValue(i)}_filterChanged(e){if(!this._opened)return;let t=this._items;const i=e.target,s=e.detail.value.trim().split(" ").map(String).filter(e=>e.length).map(e=>e.trim());s.length&&(t=t.filter(e=>s.every(t=>{var i;return e.primary.includes(t)||(null===(i=e.secondary)||void 0===i?void 0:i.includes(t))}))),i.filteredItems=t}_clear(e){e.stopPropagation(),this._setValue(void 0)}_setValue(e){this.value=e,$s(this,"value-changed",{value:e})}async focus(){var e;await this.updateComplete,await(null===(e=this._comboBox)||void 0===e?void 0:e.focus())}async open(){var e;this._opened=!0,this._isOpening=!0,await this.updateComplete,null===(e=this._comboBox)||void 0===e||e.focus(),this._comboBox.open(),this._comboBox.value=""}async _openedChanged(e){var t;const i=e.detail.value;e.stopPropagation(),this._isOpening?this._isOpening=!1:this._opened&&!i&&(this._opened=!1,await this.updateComplete,null===(t=this._field)||void 0===t||t.focus())}static get styles(){return[r`
        .container {
          position: relative;
          display: block;
        }
      ...
      `]}};t([de({attribute:!1})],Xs.prototype,"hass",void 0),t([de({type:Boolean})],Xs.prototype,"autofocus",void 0),t([de({type:Boolean})],Xs.prototype,"disabled",void 0),t([de({type:Boolean,attribute:"allow-custom-value"})],Xs.prototype,"allowCustomValue",void 0),t([de()],Xs.prototype,"label",void 0),t([de()],Xs.prototype,"value",void 0),t([de()],Xs.prototype,"helper",void 0),t([de()],Xs.prototype,"placeholder",void 0),t([de({type:String,attribute:"search-label"})],Xs.prototype,"searchLabel",void 0),t([de({attribute:"hide-clear-icon",type:Boolean})],Xs.prototype,"hideClearIcon",void 0),t([de({attribute:!1,type:Array})],Xs.prototype,"getItems",void 0),t([de({attribute:!1,type:Array})],Xs.prototype,"getAdditionalItems",void 0),t([de({attribute:!1})],Xs.prototype,"rowRenderer",void 0),t([de({attribute:!1})],Xs.prototype,"valueRenderer",void 0),t([de({attribute:"not-found-label",type:String})],Xs.prototype,"notFoundLabel",void 0),t([he(".textInput")],Xs.prototype,"_field",void 0),t([he("ha-combo-box")],Xs.prototype,"_comboBox",void 0),t([ce()],Xs.prototype,"_opened",void 0),Xs=t([re("scheduler-picker")],Xs);let ea=class extends oe{constructor(){super(...arguments),this.value=[],this.multiple=!1,this.disabled=!1,this.multipleMode=!1,this.scheduleEntities=[],this._valueRenderer=e=>{Array.isArray(e)&&(e=e.length?[...e].pop():"");const t=e||"",i=this.hass.states[t];if(!i)return q`
        <ha-svg-icon
          slot="start"
          .path=${Ts}
          style="margin: 0 4px"
    ...
    `},this._filteredItems=()=>{let e=Object.keys(this.hass.states);return this.domain&&(e=e.filter(e=>Ri(e)==this.domain)),this.multiple&&(e=e.filter(e=>{var t;return!(null===(t=this.value)||void 0===t?void 0:t.includes(e))})),this.config&&(e=e.filter(e=>((this.config.include||Fe).some(t=>Hi(t,e))||Object.keys(this.config.customize||{}).some(t=>Hi(t,e)))&&!(this.config.exclude||[]).some(t=>Hi(t,e)))),e=e.filter(e=>!this.scheduleEntities.includes(e)),this.filterFunc&&(e=e.filter(e=>this.filterFunc(this.hass.states[e]))),e.map(e=>this._parseEntityItem(e))}}async firstUpdated(){this.scheduleEntities=Object.entries(await Se(this.hass)).map(([,e])=>e.entity_id),this._autoSelectIfSingleEntity()}updated(e){super.updated(e),e.has("domain")&&this._autoSelectIfSingleEntity()}_autoSelectIfSingleEntity(){if(this.value&&this.value.length>0)return;const e=this._filteredItems();1===e.length&&(this.value=[e[0].id],$s(this,"value-changed",{value:this.value}))}render(){var e;return q`
      ${this.renderChips()}
    ...
    `}renderChips(){if(!this.multiple)return V;let e=(this.value||[]).map(e=>{const t=this._parseEntityItem(e);return{name:t.primary,value:e,useStateIcon:!t.icon,icon:t.icon}});return q`
      ...
      <ha-icon-button
        ...
        .path=${this.multipleMode?"M7.41,15.41L12,10.83L16.59,15.41L18,14L12,8L6,14L7.41,15.41Z":zs}
        slot="end"
      ></ha-icon-button>
      `:V}
      </div>
      </div>
      `}_valueChanged(e){let t=e.detail.value;const i=e.currentTarget;t&&(this.value=[...this.value||[],t],this.multiple&&(i.value=""),$s(this,"value-changed",{value:this.value}),e.stopPropagation())}_removeClick(e){const t=e.detail;this.value=(this.value||[]).filter(e=>e!==t),$s(this,"value-changed",{value:this.value})}_parseEntityItem(e){var t,i,s,a;const o=Object.entries((null===(t=this.config)||void 0===t?void 0:t.customize)||{}).filter(([t,i])=>Hi(t,e)).map(([e,t])=>t),n=null===(i=o.find(e=>"name"in e))||void 0===i?void 0:i.name,r=null===(s=o.find(e=>"icon"in e))||void 0===s?void 0:s.icon;return{id:e,primary:n||Vi(e,null===(a=this.hass.states[e])||void 0===a?void 0:a.attributes),secondary:e,icon:r}}};ea.styles=r`
    :host {
      display: flex;
  ...
  `,t([de({attribute:!1})],ea.prototype,"hass",void 0),t([de()],ea.prototype,"domain",void 0),t([de()],ea.prototype,"config",void 0),t([de({type:Array})],ea.prototype,"value",void 0),t([de({type:Boolean})],ea.prototype,"multiple",void 0),t([de({type:Boolean})],ea.prototype,"disabled",void 0),t([ce()],ea.prototype,"multipleMode",void 0),t([ce()],ea.prototype,"scheduleEntities",void 0),ea=t([re("scheduler-entity-picker")],ea);let ta=class extends oe{constructor(){super(...arguments),this.expanded=!1,this.disabled=!1,this.idx=-1,this.openClose=new CustomEvent("open-close",{detail:{},bubbles:!0,composed:!0})}render(){return q`
      <div
    ...
    `}};t([de()],ia.prototype,"disabled",void 0),t([ce()],ia.prototype,"_openedItem",void 0),t([ce()],ia.prototype,"_numItems",void 0),ia=t([re("scheduler-collapsible-group")],ia);let sa=class extends oe{constructor(){super(...arguments),this.disabled=!1}render(){var e;if(this.config.select){const e=this.config.select,t=[this.value||[]].flat().map(String),i=e=>{const i=e.detail;this.value=t.filter(e=>e!=i),$s(this,"value-changed",{value:this.value})},s=()=>{let e=t.map(e=>Object({name:e,value:e}));return q`
      ...
      `}if(this.config.number){const t=this.config.number,i="box"==t.mode||!Ze(t.min)||!Ze(t.max);let s=this.value;i||"number"==typeof s||(s=t.min),"number"==typeof t.scale_factor&&(s=Number(s)/t.scale_factor),"number"==typeof(null==t?void 0:t.step)&&(s=Math.round(Number(s)/t.step)*t.step),Ze(s)&&(s=es(Number(s)));const a=e=>{let i=Number(e.target.value);"number"==typeof t.scale_factor&&(i*=t.scale_factor),"number"==typeof(null==t?void 0:t.step)&&(i=Math.round(i/t.step)*t.step),i=es(i),this._valueChanged(new CustomEvent("value-changed",{detail:{value:i}})),e.stopPropagation()},o=e=>{e.stopPropagation();let t=e.target.value;const i=""===t||isNaN(Number(t))?void 0:Number(t);this._valueChanged(new CustomEvent("value-changed",{detail:{value:i}}))},n=(e,i)=>{let s=t.step&&Number(t.step)%1==0?null!==e.match(/^-?\d+$/):null!==e.match(/^[+-]?\d+([.,]\d+)?$/);return s&&Ze(t.min)&&(s=Number(e)>=t.min),s&&Ze(t.max)&&(s=Number(e)<=t.max),{valid:s,customError:!s}};return q`
      ...
      `}if(this.config.boolean){let e={select:{options:[{value:"true",label:"True",icon:"mdi:check"},{value:"false",label:"False",icon:"mdi:close"}]}};const t=e=>{let t=Ze(e.detail.value)?"true"===e.detail.value:void 0;e.stopPropagation(),this._valueChanged(new CustomEvent("value-changed",{detail:{value:t}}))};return q`
      ...
      `}return q``}_valueChanged(e){if(e.stopPropagation(),Array.isArray(this.value)){let t=e.detail.value;if(!t)return;this.value=[...this.value,t],e.target.value=""}else if(e.detail){let t=e.detail.value;void 0===t&&(t=null),this.value=t}else this.value=e.target.value;$s(this,"value-changed",{value:this.value})}};sa.styles=r`
      :host {
        display: flex;
        width: 100%;
      }
  ...
  `,t([de({attribute:!1})],sa.prototype,"hass",void 0),t([de({attribute:!1})],sa.prototype,"config",void 0),t([de()],sa.prototype,"value",void 0),t([de()],sa.prototype,"disabled",void 0),sa=t([re("scheduler-combo-selector")],sa);let aa=class extends oe{constructor(){super(...arguments),this._config={},this.title="",this.tagOptions=[]}setConfig(e){this._config=Object.assign({},e)}async firstUpdated(){this.title="string"==typeof this._config.title?this._config.title:"";const e=(await Os(this.hass)).map(e=>e.name);e.sort(Bi),this.tagOptions=e}render(){var e,t,i,s,a,o;const n={number:{min:0,max:30,step:1,unit_of_measurement:Ni("ui.panel.card_editor.fields.time_step.unit_minutes",this.hass)}},r={select:{options:this.tagOptions,multiple:!0,custom_value:!0}};return q`
      <div class="card-config">

        <ha-button @click=${this._showIncludedEntitiesDialog} outlined>
          ${Ni("ui.panel.card_editor.fields.entities.button_label",this.hass)}
          <ha-svg-icon
            slot="trailingIcon"
        ...
        <scheduler-settings-row ?showPrefix=${!0}>
          ...
          <span slot="heading">${Ni("ui.panel.card_editor.fields.title.heading",this.hass)}</span>

          <ha-textfield
            .value=${this.title}
            @input=${this._setTitle}
            .placeholder=${Ni("ui.panel.common.title",this.hass)}
        ...
        <div class="column">
          <ha-formfield label="${Ni("ui.panel.card_editor.fields.discover_existing.heading",this.hass)}">
            <ha-switch
        ...
        <div class="column">
          <ha-formfield label="${Ni("ui.panel.card_editor.fields.show_header_toggle.heading",this.hass)}">
            <ha-switch
        ...
        <scheduler-settings-row>
          <span slot="heading">${Ni("ui.panel.card_editor.fields.time_step.heading",this.hass)}</span>
        ...
        <span>${Ni("ui.panel.card_editor.fields.default_editor.heading",this.hass)}</span>
        <div class="two-columns">
          <div class="column">
            <ha-formfield label="${Ni("ui.panel.card_editor.fields.default_editor.options.single",this.hass)}">
              <ha-radio
                name="default_editor"
                value="${_e.Single}"
          ...
          <div class="column">
            <ha-formfield label="${Ni("ui.panel.card_editor.fields.default_editor.options.scheme",this.hass)}">
              <ha-radio
                name="default_editor"
                value="${_e.Scheme}"
          ...
          <span slot="heading">${Ni("ui.panel.card_editor.fields.sort_by.heading",this.hass)}</span>

        <div class="two-columns">
        <div class="column">

          <ha-formfield label="${Ni("ui.panel.card_editor.fields.sort_by.options.relative_time",this.hass)}">
            <ha-radio
              name="sort_by"
              value="relative-time"
        ...
        <div class="column">
          ...
          <ha-formfield label="${Ni("ui.panel.card_editor.fields.sort_by.options.title",this.hass)}">
            <ha-radio
              name="sort_by"
              value="title"
              @change=${this._setSortBy}
          ...
          <span>${Ni("ui.panel.card_editor.fields.display_format_primary.heading",this.hass)}</span>


        <div class="two-columns">
        <div class="column">

          <ha-formfield label="${Ni("ui.panel.card_editor.fields.display_format_primary.options.default",this.hass)}">
            <ha-radio
        ...
        <div class="column">
          ...
          <ha-formfield label="${Ni("ui.panel.card_editor.fields.display_format_primary.options.entity_action",this.hass)}">
            <ha-radio
              name="display_format_primary"
              value="{entity}: {action}"
              @change=${this._setDisplayOptionsPrimary}
          ...
          <span>${Ni("ui.panel.card_editor.fields.display_format_secondary.heading",this.hass)}</span>

        <div class="two-columns">
        <div class="column">
          <ha-formfield label="${Ni("ui.panel.card_editor.fields.display_format_secondary.options.relative_time",this.hass)}">
            <ha-checkbox
              value="relative-time"
              @change=${this._setDisplayOptionsSecondary}
              ?checked=${[(null===(i=this._config.display_options)||void 0===i?void 0:i.secondary_info)||He].flat().includes("relative-time")}
            >
            </ha-checkbox>
          </ha-formfield>

          <ha-formfield label="${Ni("ui.panel.card_editor.fields.display_format_secondary.options.time",this.hass)}">
            <ha-checkbox
              value="time"
              @change=${this._setDisplayOptionsSecondary}
              ?checked=${[(null===(s=this._config.display_options)||void 0===s?void 0:s.secondary_info)||He].flat().includes("time")}
            >
            </ha-checkbox>
          </ha-formfield>
        ...
        <div class="column">
          <ha-formfield label="${Ni("ui.panel.card_editor.fields.display_format_secondary.options.days",this.hass)}">
            <ha-checkbox
              value="days"
              @change=${this._setDisplayOptionsSecondary}
              ?checked=${[(null===(a=this._config.display_options)||void 0===a?void 0:a.secondary_info)||He].flat().includes("days")}
            >
            </ha-checkbox>
          </ha-formfield>

          <ha-formfield label="${Ni("ui.panel.card_editor.fields.display_format_secondary.options.additional_tasks",this.hass)}">
            <ha-checkbox
              value="additional-tasks"
              @change=${this._setDisplayOptionsSecondary}
              ?checked=${[(null===(o=this._config.display_options)||void 0===o?void 0:o.secondary_info)||He].flat().includes("additional-tasks")}
            >
            </ha-checkbox>
          </ha-formfield>
        </div>
        ...
        <scheduler-settings-row>
          <span slot="heading">${Ni("ui.panel.card_editor.fields.tags.heading",this.hass)}</span>
  ...
  `,t([de({attribute:!1})],aa.prototype,"hass",void 0),t([de()],aa.prototype,"_config",void 0),t([de()],aa.prototype,"title",void 0),t([de()],aa.prototype,"tagOptions",void 0),aa=t([re("scheduler-card-editor")],aa);const oa=r`
  ha-dialog {
...
`,(e,t,i,s)=>{var a;const o=e.service,n=null===(a=e.target)||void 0===a?void 0:a.entity_id,r=Xi(e,s);if(!r||!r.fields||!Object.keys(r.fields).includes(t))return!1;const l=r.fields[t];if(null===as(o,n,t,i,s))return!1;if(Object.keys(e.service_data||{}).includes(t))return!0;if(l.supported_features){if(![n||[]].flat().every(e=>{if(!Object.keys(i.states).includes(e))return!1;return((i.states[e].attributes.supported_features||0)&l.supported_features)>0}))return!1}return!("light"==Ri(o)&&![n||[]].flat().every(e=>{if(!Object.keys(i.states).includes(e))return!1;const s=i.states[e].attributes.supported_color_modes||[];return"brightness"!=t||s.filter(e=>"onoff"!=e).length}))});var ra;!function(e){e.OverlappingTime="overlapping_time",e.MissingTargetEntity="missing_target_entity",e.MissingServiceParameter="missing_service_parameter",e.MissingAction="missing_action"}(ra||(ra={}));const la=(e,t,i)=>{let s=[];s=[...s,...e.entries.map(e=>((e,t)=>e.every((i,s)=>{const a=Te(i.start,t),o=void 0===i.stop?a:Te(i.stop,t)||86400;return!(a>o)&&e.every((e,i)=>{if(i<=s)return!0;return Te(e.start,t)>=o})})?null:ra.OverlappingTime)(e.slots,t)).filter(e=>null!==e)];let a=e.entries.map(e=>e.slots.map(e=>e.actions)).flat().flat();return a.length||(s=[...s,ra.MissingAction]),s=[...s,...a.map(e=>((e,t,i)=>{var s;const a=Xi(e,i);return(null==a?void 0:a.target)&&!(null===(s=e.target)||void 0===s?void 0:s.entity_id)?ra.MissingTargetEntity:(null==a?void 0:a.fields)&&!Object.entries(a.fields).filter(([s])=>na(e,s,t,i)).every(([s,a])=>{var o,n;let r=as(e.service,null===(o=e.target)||void 0===o?void 0:o.entity_id,s,t,i);const l=!(!r.number||!(null===(n=r.number)||void 0===n?void 0:n.optional))||a.optional;return!(!Object.keys(e.service_data).includes(s)&&!l)&&!(!Ze(e.service_data[s])&&!l)})?ra.MissingServiceParameter:null})(e,t,i)).filter(e=>null!==e)],s.length?s.shift():null},da=e=>{const t=e=>e.actions.length?(e.stop||(e=Object.fromEntries(Object.entries(e).filter(([e])=>"stop"!=e))),e):null;let i={weekdays:(e=Object.assign(Object.assign({},e),{entries:e.entries.map(e=>Object.assign(Object.assign({},e),{slots:e.slots.map(t).filter(e=>null!==e)}))})).entries[0].weekdays.map(ca),timeslots:e.entries[0].slots.map(ua),name:e.name,start_date:e.start_date,end_date:e.end_date,repeat_type:e.repeat_type,tags:e.tags||[]};return e.schedule_id&&(i=Object.assign(Object.assign({},i),{schedule_id:e.schedule_id})),i},ca=e=>{switch(e){case ge.Monday:return"mon";case ge.Tuesday:return"tue";case ge.Wednesday:return"wed";case ge.Thursday:return"thu";case ge.Friday:return"fri";case ge.Saturday:return"sat";case ge.Sunday:return"sun";case ge.Workday:return"workday";case ge.Weekend:return"weekend";default:return"daily"}},ua=e=>({start:e.start,stop:e.stop,actions:e.actions.map(e=>ha(e)).flat(),condition_type:e.conditions.items.length?e.conditions.type==ve.And?"and":"or":void 0,conditions:e.conditions.items.length?e.conditions.items:void 0,track_conditions:e.conditions.track_changes}),ha=e=>{var t,i;const s=e=>Object.keys(e).filter(t=>Ze(e[t])).reduce((t,i)=>(t[i]=e[i],t),{});if(e.target){if(Array.isArray(null===(t=e.target)||void 0===t?void 0:t.entity_id)){return null==e?void 0:e.target.entity_id.map(t=>({service:e.service,service_data:s(e.service_data),entity_id:t}))}return{service:e.service,service_data:s(e.service_data),entity_id:null===(i=e.target)||void 0===i?void 0:i.entity_id}}return{service:e.service,service_data:s(e.service_data)}},ma=(e,t,i)=>{const s={title:Zi("state_badge.default.error",i),description:q`
    <b>Something went wrong!</b><br />
    ${e.body.message}<br /><br />
    ${e.error}<br /><br />
    Please <a href="https://github.com/nielsfaber/scheduler-card/issues">report</a> the bug.
  `,primaryButtonLabel:Zi("ui.common.ok",i),confirm:()=>{},cancel:()=>{}};$s(t,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return Ha})),dialogParams:s})},pa=e=>{if(!Object.keys(e).includes("select")||!e.select){if(Object.keys(e).includes("number")&&e.number){const t=e.number.min;return void 0!==t?t:0}return Object.keys(e).includes("boolean")&&e.boolean?void 0:(Object.keys(e).includes("text")&&e.text,"")}e.select.options},_a=(e,t)=>{const i=Xi(e,t),s=Ri(e.service),a=qi(e.service);if(i.icon)return(o=i.icon).match(/^[a-z]+\:[a-zA-Z\-]+$/)?o:"mdi:"+o;if(Object.keys(ss).includes(s)&&Object.keys(ss[s].services).includes(a)){if(void 0!==ss[s].attributes){let t=ss[s].attributes;const i=Object.keys(t).find(t=>Object.keys(e.service_data).includes(t));if(i&&Object.keys(t[i]).includes(e.service_data[i]))return t[i][e.service_data[i]]}return ss[s].services[a]}return Object.keys(ss).includes(s)&&Object.keys(ss[s].services).includes("{entity_id}")?ss[s].services["{entity_id}"]:"mdi:flash";var o},ga=(e,t,i)=>{let s=Te("string"==typeof e?Ee(e):e,i),a=Te("string"==typeof t?Ee(t):t,i);return a>s?1:a<s?-1:0},va=e=>Ee(e.start),ya=e=>{if(Ze(e.stop)){const t=Ee(e.stop);return 0==t.hours&&0==t.minutes&&t.mode==we.Fixed?Object.assign(Object.assign({},t),{hours:24}):t}return Ce(va(e),{minutes:1})},fa=(e,t,i,s)=>{let a=t;if(i.stop)return[e,a]=fa(e,t+1,{start:i.stop},s),[e,a-1];if(i.start){let o=va(e[t]),n=i.start;if(ga(o,n,s)<0){let i=va(e[t]);for(let s=t-1;s>=0;s--){if(e[s].actions.length){i=s==t-1?Ce(va(e[s]),{minutes:1}):ya(e[s]);break}i=va(e[s])}ga(i,n,s)<0&&(n=i),e=Object.assign(e,{[t]:Object.assign(Object.assign({},e[t]),{start:qe(n)})});for(let i=t-1;i>=0;i--){let t=ga(va(e[i]),n,s),o=ga(ya(e[i]),n,s);if(t>0&&o<0){e=Object.assign(e,{[i]:Object.assign(Object.assign({},e[i]),{stop:qe(n)})});break}if(o>=0)break;t<=0&&(e=Object.assign(e,{[i]:null}),a-=1)}Ze(e[t].stop)||(e=Ze(e[t+1].stop)&&!e[t+1].actions.length?Object.assign(e,{[t+1]:Object.assign(Object.assign({},e[t+1]),{start:qe(ya(e[t]))})}):[...e.slice(0,t+1),Object.assign(Object.assign({},e[t]),{start:qe(ya(e[t])),stop:qe(va(e[t+1])),actions:[]}),...e.slice(t+1)])}else if(ga(o,n,s)>0){let i=Ce(ya(e[t]),{minutes:-1});if(!Ze(e[t].stop))for(let s=t+1;s<e.length;s++){if(e[s].actions.length){i=s==t+1?Ce(ya(e[s]),{minutes:-1}):va(e[s]);break}i=ya(e[s])}ga(i,n,s)>0&&Te(i,s)>0&&(n=i),e=Object.assign(e,{[t]:Object.assign(Object.assign({},e[t]),{start:qe(n)})}),t>0&&Ze(e[t-1].stop)?e=Object.assign(e,{[t-1]:Object.assign(Object.assign({},e[t-1]),{stop:qe(n)})}):(e=[...e.slice(0,t),Object.assign(Object.assign({},e[t]),{start:t>0?qe(ya(e[t-1])):"00:00:00",stop:qe(n),actions:[]}),...e.slice(t)],a=t+1);for(let t=a+1;t<e.length;t++){let i=ya(e[a]),o=ga(va(e[t]),i,s),n=ga(ya(e[t]),i,s);if(o>0&&n<0)e=Object.assign(e,{[t]:Object.assign(Object.assign({},e[t]),{start:qe(i)})});else{if(o<0)break;n>=0&&(e=Object.assign(e,{[t]:null}))}}}}return[e=e.filter(Ze),a]},ba=(e,t)=>{const i=new Date(t),s=3600*i.getHours()+60*i.getMinutes()+i.getSeconds();let a=3600*e.hours+60*e.minutes-s;const o=a<0?-1:1;a=Math.abs(a);let n=Math.floor(a/3600),r=Math.round((a-3600*n)/60);return o<0&&(n>0&&(n=-n),r=-r),Ae({hours:n,minutes:r})};let ka=class extends oe{constructor(){super(),this.selectedSlot=null,this.timeout=0,this.large=!1,this.handleResize=this.handleResize.bind(this)}handleResize(e){clearTimeout(this.timeout),this.timeout=window.setTimeout(()=>{this.requestUpdate()},50)}firstUpdated(){}render(){return q`
      <div class="bar">
    ...
    `}renderTimebar(){const e=parseFloat(getComputedStyle(this).getPropertyValue("width")),t=[1,2,3,4,6,8,12],i=Le(this.hass.locale),s=i?130:100;let a=Math.ceil(24/(e/s));for(;!t.includes(a);)a++;const o=[0,...Array.from(Array(24/a-1).keys()).map(e=>(e+1)*a),24];return o.map((e,t)=>{let s=a/24*100;s=Math.floor(100*s)/100;let n={mode:we.Fixed,hours:e,minutes:0};return 0==t?q`
        <span class="left" style=${Rs({width:s/2+"%"})}>${qe(n,{seconds:!1,am_pm:i})}</span>
      `:t==o.length-1?q`
        <span class="right" style=${Rs({width:s/2+"%"})}>${qe(n,{seconds:!1,am_pm:i})}</span>
      `:q`
        <span style=${Rs({width:s+"%"})}>${qe(n,{seconds:!1,am_pm:i})}</span>
      `})}renderTimeslots(){const e=this.schedule.slots,t=this.computeSlotWidths();return e.map((i,s)=>{let a=Te(i.start,this.hass),o=Te(i.stop||i.start,this.hass);!o&&a&&(o=86400);const n=(o-a)/86400*100,r=i.actions.length?hs(i.actions[0],this.hass,this.config.customize,!0,!0):"",l=parseFloat(getComputedStyle(this).getPropertyValue("width")),d=5*r.length+10,c=s>0?15:0,u=s<e.length-1?15:0,h=n*l/100-c-u,m=e[s+1];return q`
        <div
          class="slot ${this.selectedSlot==s?"selected":""} ${i.actions.length?"":"empty"} ${void 0===i.stop?"short":""}"
          style="${Rs({width:t[s]+"px"})}"
          @click=${this._toggleSelectTimeslot}
          idx="${s}"
        >
          ${i.stop,""}
          ${i.actions.length?r&&(h>d/3||h>50)&&h>30?q`<span style="margin-left: ${c}px; margin-right: ${u}px">${r}</span>`:h>16?q`<ha-icon icon="${_a(i.actions[0],this.config.customize)}"></ha-icon>`:"":""}
        </div>
    ...
    `}};t([de({attribute:!1})],ka.prototype,"config",void 0),t([ce()],ka.prototype,"schedule",void 0),t([ce()],ka.prototype,"selectedSlot",void 0),t([de({type:Boolean})],ka.prototype,"large",void 0),t([function(e){return ue({finisher:(t,i)=>{Object.assign(t.prototype[i],e)}})}({passive:!0})],ka.prototype,"_handleDragStart",null),ka=t([re("scheduler-timeslot-editor")],ka);const wa=e=>{let t=60*e.hours+e.minutes;return t>240?e=Object.assign(Object.assign({},e),{hours:4,minutes:0}):t<-240&&(e=Object.assign(Object.assign({},e),{hours:-4,minutes:0})),e};let xa=class extends oe{constructor(){super(...arguments),this.hours=0,this.minutes=0,this.mode=we.Fixed,this.autoValidate=!0,this.required=!0,this.disabled=!1,this.label="",this.useAmPm=!1,this.large=!1,this.stepSize=10}set time(e){const t=Ee(e);this.mode=t.mode,this.hours=t.hours,this.minutes=t.minutes}render(){return q`
    ...
    `}_renderTimeMode(){if(!this.hass.states["sun.sun"])return V;if(this.large){const e=()=>{let e=this._convertTimeMode();e.mode!=we.Fixed&&(e=wa(e)),this.mode=e.mode,this.hours=e.hours,this.minutes=e.minutes,this._valueChanged()};return q`
        <div class="mode">
    ...
    `}}_renderSuffix(){if(this.large){const e=()=>{let e=Ie(this.hours).am_pm;const t=Ie(this.hours).hours;this.hours=Ne(t,"AM"==e?Pe.PM:Pe.AM),this._valueChanged()},t=()=>{0!=this.hours?this.hours=-this.hours:this.minutes=-this.minutes,this._valueChanged()},i=()=>{this.mode=this.mode==we.Sunrise?we.Sunset:we.Sunrise,this._valueChanged()};return q`
        ...
        ${this.useAmPm&&this.mode==we.Fixed?q`
            <ha-button appearance="plain" @click=${e}>
              <span class="large">
                ${Ie(this.hours).am_pm==Pe.AM?"AM":"PM"}
              </span>
            </ha-button>
          `:V}
      ...
      `:V}_convertTimeMode(e){const t=this.hass.states["sun.sun"].attributes.next_rising,i=this.hass.states["sun.sun"].attributes.next_setting;if(e&&e!=we.Fixed||this.mode==we.Fixed){const s=ba({hours:this.hours,minutes:this.minutes},t),a=ba({hours:this.hours,minutes:this.minutes},i),o=60*s.hours+s.minutes,n=60*a.hours+a.minutes;let r=e||(Math.abs(o)<=Math.abs(n)?we.Sunrise:we.Sunset),l=r==we.Sunrise?s:a;return{mode:r,hours:l.hours,minutes:l.minutes}}{let e=this.mode==we.Sunrise?Ee(t):Ee(i);return e=Ce(e,{hours:this.hours,minutes:this.minutes}),{mode:we.Fixed,hours:e.hours,minutes:e.minutes}}}_hoursChanged(e){let t=Number(e.target.value);if(this.useAmPm){const e=Ie(this.hours).am_pm;t=Ne(t,e)}this.hours=t,this._valueChanged()}_minutesChanged(e){const t=Number(e.target.value);this.minutes=t,this._valueChanged()}_amPmChanged(e){const t=e.target.value;if(Ie(this.hours).am_pm==t)return;const i=Ie(this.hours).hours;this.hours=Ne(i,"AM"==t?Pe.AM:Pe.PM),this._valueChanged()}_addTimeOffset(e){let t={mode:this.mode,hours:this.hours,minutes:this.minutes};t=Ce(t,e),this.mode!=we.Fixed&&(t=wa(t)),this.hours=t.hours,this.minutes=t.minutes,this._valueChanged()}_valueChanged(){const e={mode:this.mode,hours:this.hours,minutes:this.minutes};$s(this,"value-changed",{value:e})}_onFocus(e){e.currentTarget.select()}formatHours(){const e=this.hours<0||this.minutes<0;let t=this.useAmPm&&this.mode==we.Fixed?Ie(this.hours).hours:this.hours;return e&&!this.large?"-"+Math.abs(t).toFixed():this.mode==we.Fixed||this.large?this.large?Math.abs(t):t.toFixed():"+"+Math.abs(t).toFixed()}formatMinutes(){return Math.abs(this.minutes).toString().padStart(2,"0")}};xa.styles=r`
    :host {
      display: flex;
      flex-direction: row;
      flex-wrap: wrap;
  ...
  `,t([de({attribute:!1})],xa.prototype,"hass",void 0),t([ce()],xa.prototype,"hours",void 0),t([ce()],xa.prototype,"minutes",void 0),t([ce()],xa.prototype,"mode",void 0),t([de({type:Boolean})],xa.prototype,"autoValidate",void 0),t([de({type:Boolean})],xa.prototype,"required",void 0),t([de({type:Boolean})],xa.prototype,"disabled",void 0),t([de({type:String})],xa.prototype,"label",void 0),t([de({type:Boolean})],xa.prototype,"useAmPm",void 0),t([de({type:Boolean})],xa.prototype,"large",void 0),t([de({attribute:!1})],xa.prototype,"stepSize",void 0),xa=t([re("scheduler-time-picker")],xa);let $a=class extends oe{constructor(){super(...arguments),this.weekdayTypeCustomSelected=!1,this.selectedWeekdays=[]}async showDialog(e){this._params=e,await this.updateComplete,this.selectedWeekdays=this._params.weekdays.filter(e=>![ge.Daily,ge.Weekend,ge.Workday].includes(e)),this.weekdayTypeCustomSelected=this.selectedWeekdays.length>0}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?q`
      <ha-dialog open .heading=${!0} @closed=${this.closeDialog} @close-dialog=${this.closeDialog}>
        <ha-dialog-header slot="heading">
          ...
          `};
          <span slot="title">
              ${Ni("ui.dialog.weekday_picker.title",this.hass)}
          </span>
        </ha-dialog-header>
        <div class="wrapper">
          <mwc-list>
    ...
    `:q``}_renderWeekdayOptions(){let e=[];if(this.weekdayTypeCustomSelected){e=[ge.Sunday,ge.Monday,ge.Tuesday,ge.Wednesday,ge.Thursday,ge.Friday,ge.Saturday];e=((e,t)=>e.concat(e).slice(t,t+e.length))(e,gs(this.hass))}else e=[ge.Daily,ge.Workday,ge.Weekend,"Custom"];const t=e=>{var t,i;return"Custom"==e?null===(t=this._params)||void 0===t?void 0:t.weekdays.every(e=>![ge.Daily,ge.Weekend,ge.Workday].includes(e)):null===(i=this._params)||void 0===i?void 0:i.weekdays.includes(e)};return e.map(e=>q`
        <mwc-list-item
          graphic="icon"
        ...
        >
          ...
          ${"Custom"==e?q`
            ...
            ${Wi(Ni("ui.dialog.weekday_picker.choose",this.hass))}
            ${t(e)?q`<span class="badge">${this.selectedWeekdays.length}</span>`:""}
            `:Wi(_s(e,"long",this.hass))}
    ...
    `}};t([de({attribute:!1})],$a.prototype,"hass",void 0),t([ce()],$a.prototype,"_params",void 0),t([ce()],$a.prototype,"weekdayTypeCustomSelected",void 0),$a=t([re("dialog-select-weekdays")],$a);var ja=Object.freeze({__proto__:null,get DialogSelectWeekdays(){return $a}});const Oa=(e,t)=>((e,t)=>e<t?-1:e>t?1:0)(e.toLowerCase(),t.toLowerCase()),za=(e,t,i)=>{const s=Object.keys(e.services).includes(t)?Object.keys(e.services[t]).filter(e=>{if(!Object.keys(Gi).includes(t))return!1;let s=Object.keys(Gi[t]).includes(e);if(!s&&Object.keys(Gi[t]).includes("{entity_id}")){if("script"==t&&["turn_on","turn_off","reload","toggle","test"].includes(e))return!1;s=Fi(`${t}.${e}`,i)}return s}):[],a=t=>Zi(`component.${t}.title`,e,!1)||t.replace(/_/g," "),o=s=>{const o=Zi(`component.${t}.services.${s}.name`,e,!1)||!!e.services[t]&&!!e.services[t][s]&&e.services[t][s].name||s.replace(/_/g," ");return"script"==t?Object.keys(i.customize||{}).includes(`${t}.${s}`)&&Ze(i.customize[`${t}.${s}`].name)?i.customize[`${t}.${s}`].name:o:`${a(t)}: ${o}`},n=i=>{let s=Zi(`component.${t}.services.${i}.description`,e,!1);return s||(s=e.services[t][i].description),s||"script"!=t||(s=Zi(`component.${t}.services.turn_on.description`,e,!1)),s};let r=s.map(s=>{return{key:s,name:o(s),description:n(s),icon:(a=s,"script"==t&&Object.keys(i.customize||{}).includes(`${t}.${a}`)&&Ze(i.customize[`${t}.${a}`].icon)?i.customize[`${t}.${a}`].icon:Object.keys(ss).includes(t)&&Object.keys(ss[t].services).includes(a)?ss[t].services[a]:Ms(t)),action:{service:s.includes(".")?s:`${t}.${s}`,service_data:{},target:e.services[t][s].target?{}:void 0}};var a}),l=(d=i.customize||{},c=t,Object.keys(d).filter(e=>{var t;return null===(t=d[e].exclude_actions)||void 0===t?void 0:t.length}).filter(e=>!c||!c.includes(".")&&Hi(Ri(e),c)||Hi(e,c)).map(e=>d[e].exclude_actions).flat().filter(Ze));var d,c;return l.length&&(r=r.filter(t=>!l.some(s=>Oa(qi(t.action.service),s)>0||Oa(hs(t.action,e,i.customize),s)>0))),Qi(i.customize||{},t).forEach(e=>{let i=e.service;for(;r.find(e=>e.key==i);)i+="_2";e.variables&&Object.entries(e.variables).forEach(([t,i])=>{let s=rs(i),a=pa(s);!Ze(e.service_data[t])&&Ze(a)&&(e=Object.assign(Object.assign({},e),{service_data:Object.assign(Object.assign({},e.service_data),{[t]:a})}))}),r.push({key:i,name:`${a(t)}: ${Sa(e.name||o(qi(e.service)))}`,description:Sa(e.name||""),icon:e.icon||Ms(t),action:{service:e.service.includes(".")?e.service:`${t}.${e.service}`,service_data:e.service_data||{},target:e.target?e.target:void 0,name:e.name,icon:e.icon}})}),r},Sa=e=>{if(null!==/<.+?>/g.exec(e)){e=(new DOMParser).parseFromString(e,"text/html").body.textContent||""}let t;for(;t=/\[([^\]]+)\]/.exec(e);)e=e.replace(t[0],"");for(;t=/\{([^\}]+)\}/.exec(e);)e=e.replace(t[0],"");return e};let Ca=class extends oe{constructor(){super(...arguments),this._search="",this._filter="",this.timer=0,this.lockDomain=!1}async showDialog(e){this._params=e,e.domainFilter&&(this.lockDomain=!0),await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0,this._clearSearch(),this._height=void 0,this._width=void 0}async willUpdate(){this.hass.loadBackendTranslation("title"),this.hass.loadBackendTranslation("services")}render(){return this._params?q`
      <ha-dialog
        open
        .heading=${!0}
        @opened=${this._opened}
      ...
      >
        <div slot="heading">
          <ha-dialog-header>
            ...
            `}
            <span slot="title">
              ${Ni("ui.dialog.action_picker.title",this.hass)}
            </span>
          </ha-dialog-header>
    ...
    `}};t([de({attribute:!1})],Ca.prototype,"hass",void 0),t([ce()],Ca.prototype,"_params",void 0),t([ce()],Ca.prototype,"_search",void 0),t([ce()],Ca.prototype,"_filter",void 0),t([ce()],Ca.prototype,"_width",void 0),t([ce()],Ca.prototype,"_height",void 0),t([ce()],Ca.prototype,"lockDomain",void 0),Ca=t([re("dialog-select-action")],Ca);var Aa=Object.freeze({__proto__:null,get DialogSelectAction(){return Ca}});let Ea=class extends oe{constructor(){super(...arguments),this.showPrefix=!1}render(){return q`
      ${this.showPrefix?q`
    ...
    `}};t([de({type:Boolean})],Ea.prototype,"showPrefix",void 0),Ea=t([re("scheduler-settings-row")],Ea);let Ta=class extends oe{constructor(){super(...arguments),this.selectedSlot=null,this.large=!1,this.selectedEntry=0}shouldUpdate(e){return e.get("schedule")&&this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule}})),!0}render(){return q`
    ${this.schedule.entries.map((e,t)=>q`
      
      <div class="editor-header">
        <div class="weekdays">
          <span>
            ${Ni("ui.panel.editor.repeated_days",this.hass)}:
            ${ys(e.weekdays,"short",this.hass)}
          </span>
          <ha-icon-button .path=${Es} @click=${e=>this._showWeekdayDialog(e,t)}></ha-icon-button>
        </div>
        <div class="weekdays-actions">
        <ha-button appearance="plain" size="small" @click=${this.toggleViewMode}>
          ${this.viewMode==_e.Scheme?Ni("ui.panel.editor.toggle_single_mode",this.hass):Ni("ui.panel.editor.toggle_scheme_mode",this.hass)}
    ...
    `}renderSlot(){if(null===this.selectedEntry||null===this.selectedSlot)return q`
        <div class="slot-placeholder"> 
          ${Ni("ui.panel.editor.select_timeslot",this.hass)}
        </div>
      ...
      <div class="two-column">
        <div class="column">
          <scheduler-time-picker
            .hass=${this.hass}
            label="${Ni("ui.panel.editor.start_time",this.hass)}:"
        ...
        <div class="column">
          ...
          <scheduler-time-picker
            .hass=${this.hass}
            label="${Ni("ui.panel.editor.stop_time",this.hass)}:"
      ...
      ${Ni("ui.panel.editor.action",this.hass)}:
    ...
    `}_renderActionConfig(){var e,t,i,s;const a=Object.assign({},this.schedule.entries[this.selectedEntry].slots[this.selectedSlot]),o=a.actions.length?a.actions[0]:void 0;if(!o)return q`
      <div>
        ...
        >
          ...
          ${Ni("ui.panel.editor.add_action",this.hass)}
        </ha-button>
      </div>
    `;const n=Xi(o,this.config.customize),r=(null===(e=n.target)||void 0===e?void 0:e.domain)||Ri(o.service),l=Ze(null===(t=null==n?void 0:n.target)||void 0===t?void 0:t.entity_id)||this.schedule.entries[this.selectedEntry].slots.some(e=>{var t,i;return e.actions.length&&Ze(null===(i=null===(t=Xi(e.actions[0],this.config.customize))||void 0===t?void 0:t.target)||void 0===i?void 0:i.entity_id)});if(void 0===n)return q``;const d=Object.keys(n.fields||{}).filter(e=>na(o,e,this.hass,this.config.customize));let c="",u=[(null===(i=o.target)||void 0===i?void 0:i.entity_id)||[]].flat();return!u.length&&["notify","script"].includes(r)&&(u=[o.service]),u.length&&(c+=u.map(e=>fs(e,this.hass,this.config.customize)).join(", "),c+=": "),c+=hs(o,this.hass,this.config.customize,!1,!0),q`
      <scheduler-collapsible-section
        ?expanded=${!0}
        ?disabled=${!0}
      >
        <div slot="header" class="header">
          <ha-icon slot="icon" icon="${_a(o,this.config.customize)}"></ha-icon>
          <span>${Wi(c)}</span>
        </div>
        ...
        <ha-button-menu
          ...
          fixed
        >
          <ha-icon-button slot="trigger" .path=${As}>
          </ha-icon-button>
        ...
        <div slot="content">
          ...
          ${d.map(e=>{var t;const i=as(o.service,null===(t=o.target)||void 0===t?void 0:t.entity_id,e,this.hass,this.config.customize);if(null===i)return"";let s=n.fields[e].optional||(i.number||{}).optional;const a=!s||Object.keys(o.service_data).includes(e);return q`
            <scheduler-settings-row ?showPrefix=${s}>
              ...
              `:""}
              <span slot="heading">
                ${((e,t,i,s)=>{var a;const o=Ri(e.service),n=qi(e.service);let r=Zi(`component.${o}.services.${n}.fields.${t}.name`,i,!1);!r&&i.services[o]&&i.services[o][e.service]&&i.services[o][e.service].fields&&i.services[o][e.service].fields[t]&&(r=String(i.services[o][e.service].fields[t].name));const l=["script","notify"].includes(o)?[e.service]:[(null===(a=e.target)||void 0===a?void 0:a.entity_id)||[]].flat();let d=Qi(s||{},l.length?l[0]:o);if(d.length){let i=d.map(i=>{if(i.service!=e.service||!Object.keys(i.variables||{}).includes(t))return null;return(i.variables||{})[t].name}).filter(e=>void 0!==e);if(i.length)return i[0]}return r||(r=t.replace(/_/g," ")),r})(o,e,this.hass,this.config.customize)}
              </span>
              <scheduler-combo-selector
                .hass=${this.hass}
                .config=${i}
  ...
  mwc-list-item.warning, mwc-list-item.warning ha-icon {
    ...
    `}};t([de({attribute:!1})],Ta.prototype,"hass",void 0),t([de({attribute:!1})],Ta.prototype,"config",void 0),t([de({attribute:!1})],Ta.prototype,"viewMode",void 0),t([de({attribute:!1})],Ta.prototype,"selectedSlot",void 0),t([de({type:Boolean})],Ta.prototype,"large",void 0),t([ce()],Ta.prototype,"schedule",void 0),t([ce()],Ta.prototype,"selectedEntry",void 0),Ta=t([re("scheduler-main-panel")],Ta);const Da=["January","February","March","April","May","June","July","August","September","October","November","December"];function Ma(e){return e.toISOString().split("T")[0]}function La(e){let t=new Date;const i=(e||"").match(/^([0-9]{4})-([0-9]{2})-([0-9]{2})/);null!==i&&t.setFullYear(Number(i[1]),Number(i[2])-1,Number(i[3]));const s=(e||"").match(/([0-9]{2}):([0-9]{2})(:([0-9]{2}))?$/);return null!==s&&t.setHours(Number(s[1]),Number(s[2]),s.length>4?Number(s[4]):t.getSeconds()),t}const Pa=(e,t)=>"select"in t&&null!==t.select?((e,t)=>{var i;return((null===(i=t.select)||void 0===i?void 0:i.options)||[]).some(t=>"object"==typeof t?t.value==e:t==e)})(String(e),t):"number"in t&&null!==t.number?((e,t)=>{var i,s;return!isNaN(e)&&(!(void 0!==(null===(i=t.number)||void 0===i?void 0:i.min)&&e<t.number.min)&&!(void 0!==(null===(s=t.number)||void 0===s?void 0:s.max)&&e>t.number.max))})(Number(e),t):!("text"in t)||null===t.text||String(e).length>0,Ia=e=>null==e||Array.isArray(e)?e:[e];let Na=class extends oe{constructor(){super(...arguments),this._search="",this._filter="",this.timer=0}async showDialog(e){this._params=e,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0,this._clearSearch(),this._height=void 0,this._width=void 0}async willUpdate(){this.hass.loadBackendTranslation("title")}render(){return this._params?q`
      <ha-dialog
        open
        .heading=${!0}
        @opened=${this._opened}
      ...
      >
        <div slot="heading">
          <ha-dialog-header>
            ...
            ></ha-icon-button>
            <span slot="title">
              ${Ni("ui.panel.options.conditions.add_condition",this.hass)}
            </span>
          </ha-dialog-header>
    ...
    `}};t([de({attribute:!1})],Na.prototype,"hass",void 0),t([ce()],Na.prototype,"_params",void 0),t([ce()],Na.prototype,"_search",void 0),t([ce()],Na.prototype,"_filter",void 0),t([ce()],Na.prototype,"_width",void 0),t([ce()],Na.prototype,"_height",void 0),Na=t([re("dialog-select-condition")],Na);var qa=Object.freeze({__proto__:null,get DialogSelectCondition(){return Na}});let Ra=class extends oe{constructor(){super(...arguments),this.conditionIdx=-1,this.conditionValid=!0,this.startDate="",this.endDate="",this.tags=[]}async firstUpdated(){var e,t;(await window.loadCardHelpers()).importMoreInfoControl("input_datetime"),this.startDate=(null===(e=this.schedule)||void 0===e?void 0:e.start_date)||Ma(new Date),this.endDate=(null===(t=this.schedule)||void 0===t?void 0:t.end_date)||Ma(new Date);const i=(await Os(this.hass)).map(e=>e.name),s=[...this.config.tags||[]].flat();this.tags=[...i,...s.filter(e=>!i.includes(e)&&!["none","disabled","enabled"].includes(e))]}shouldUpdate(e){return e.get("schedule")&&this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule}})),!0}render(){const e={select:{options:this.tags,multiple:!0,custom_value:!0}};return q`
      <div class="header first">
        <span>${Ni("ui.panel.options.conditions.header",this.hass)}:</span>
      ...
      <span class="header">${Ni("ui.panel.options.period.header",this.hass)}:</span>
      <div class="period">
        <ha-checkbox
        ...
        <span>${Ni("ui.panel.options.period.start_date",this.hass)}</span>
        <ha-date-input
        ...
        <span>${Ni("ui.panel.options.period.end_date",this.hass)}</span>
        <ha-date-input
          .locale=${this.hass.locale}
          value=${this.endDate}
      ...
      <span class="header">${Ni("ui.panel.options.tags",this.hass)}:</span>
      <div>
        <scheduler-combo-selector
          .hass=${this.hass}
          .config=${e}
      ...
      <span class="header">${Ni("ui.panel.options.repeat_type",this.hass)}:</span>
      <ha-button
    ...
    `}renderConditions(){let e=this.schedule.entries[0].slots[0].conditions.items;return this.conditionIdx==e.length&&(e=[...e,{}]),e.map((e,t)=>{const i=this.conditionIdx==t?this.selectedEntity||e.entity_id||"":e.entity_id||"",s=this.conditionIdx==t&&this.selectedDomain||Ri(i),a=Us(i||s,this.hass,this.config.customize),o=a&&a.hasOwnProperty("number")?[ye.Above,ye.Below]:[ye.Equal,ye.Unequal],n={[ye.Equal]:"mdi:equal",[ye.Unequal]:"mdi:not-equal-variant",[ye.Above]:"mdi:greater-than",[ye.Below]:"mdi:less-than"},r={[ye.Equal]:"ui.panel.options.conditions.types.equal_to",[ye.Unequal]:"ui.panel.options.conditions.types.unequal_to",[ye.Above]:"ui.panel.options.conditions.types.above",[ye.Below]:"ui.panel.options.conditions.types.below"};return this.conditionIdx!==t||this.selectedMatchType||(this.selectedMatchType=o[0]),q`
      <scheduler-collapsible-section idx="${t}">
        ...
        <scheduler-settings-row>
          <span slot="heading">
            ${Zi("ui.components.selectors.selector.types.entity",this.hass)}
          </span>
          <scheduler-entity-picker
            .hass=${this.hass}
            .config=${this.config}
            .domain=${s}
            @value-changed=${this._selectEntity}
            .value=${this.conditionIdx==t?Ia(this.selectedEntity):Ia(e.entity_id)}
            ?multiple=${!1}
          >
          </scheduler-entity-picker>
        </scheduler-settings-row>
        ...
        <scheduler-settings-row>
          <span slot="heading">
            ${Wi(Ni(r[this.conditionIdx==t?this.selectedMatchType:e.match_type],this.hass,["{entity}","{value}"],["",""]))}
            <ha-button-menu
              @action=${e=>this._selectMatchType(e,o)}
              @closed=${e=>{e.stopPropagation()}}
              fixed
            >
              <ha-icon-button slot="trigger" .path=${Es}>
              </ha-icon-button>
              ${o.map(i=>q`
                <mwc-list-item graphic="icon" ?noninteractive=${this.conditionIdx==t?this.selectedMatchType==i:e.match_type==i}>
                  ${Wi(Ni(r[i],this.hass,["{entity}","{value}"],["",""]))}
    ...
    `}};t([de({attribute:!1})],Ra.prototype,"hass",void 0),t([de({attribute:!1})],Ra.prototype,"config",void 0),t([ce()],Ra.prototype,"schedule",void 0),t([ce()],Ra.prototype,"conditionIdx",void 0),t([ce()],Ra.prototype,"selectedDomain",void 0),t([ce()],Ra.prototype,"selectedEntity",void 0),t([ce()],Ra.prototype,"selectedMatchType",void 0),t([ce()],Ra.prototype,"conditionValue",void 0),t([ce()],Ra.prototype,"conditionValid",void 0),t([ce()],Ra.prototype,"startDate",void 0),t([ce()],Ra.prototype,"endDate",void 0),t([de()],Ra.prototype,"tags",void 0),Ra=t([re("scheduler-options-panel")],Ra);let Va=class extends oe{async showDialog(e){this._params=e,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?q`
      <ha-dialog open .heading=${!0} @closed=${this.closeDialog} @close-dialog=${this.closeDialog}>
        <ha-dialog-header slot="heading">
          <ha-icon-button
            slot="navigationIcon"
    ...
    `}};t([de({attribute:!1})],Va.prototype,"hass",void 0),t([ce()],Va.prototype,"_params",void 0),Va=t([re("scheduler-generic-dialog")],Va);var Ha=Object.freeze({__proto__:null,get GenericDialog(){return Va}});let Fa=class extends oe{constructor(){super(...arguments),this.large=!1,this.selectedEntry=0,this.selectedSlot=null,this._panel="main",this._viewMode=_e.Single}set viewMode(e){if(this._viewMode=e,e==_e.Single){let e=this.schedule.entries[this.selectedEntry].slots.findIndex(e=>e.actions.length);this.selectedSlot=e>=0?e:1}}shouldUpdate(e){return 1!=e.size||!e.has("hass")||!Ze(this.hass)}async showDialog(e){var t;this._params=e,this.schedule=e.schedule,this._panel="main",this.large=!1;const i=this.schedule.entries[this.selectedEntry].slots.filter(e=>e.actions.length&&Ze(e.stop)).length>0||this.schedule.entries[this.selectedEntry].slots.filter(e=>e.actions.length).length>1||this.schedule.entries[this.selectedEntry].slots.length>3;let s=this.schedule.entries[this.selectedEntry].slots.findIndex(e=>e.actions.length);this.selectedSlot=s>=0?s:null,this.viewMode=i?_e.Scheme:(null===(t=this._params)||void 0===t?void 0:t.cardConfig.default_editor)||_e.Single,await this.updateComplete}async closeDialog(){this._params=void 0}willUpdate(){this.hass.loadBackendTranslation("config")}render(){var e;return this._params?q`
      <ha-dialog open @closed=${this.closeDialog} .heading=${!0} hideActions scrimClickAction="">
        <ha-dialog-header slot="heading">
          ...
          <span slot="title" @click=${()=>this.large=!this.large}>
            ${this._params.editItem?this.schedule.name?null===(e=this.schedule)||void 0===e?void 0:e.name:Ni("ui.panel.common.default_name",this.hass,"{id}",this._params.editItem):Ni("ui.panel.common.new_schedule",this.hass)}
          </span>
    ...
    `:q``}_updateSchedule(e){let t=Object.keys(e.detail);if(t.includes("schedule")){let t=e.detail.schedule;this.schedule=t}t.includes("selectedSlot")&&(this.selectedSlot=e.detail.selectedSlot)}async _handleSaveClick(e){const t=la(this.schedule,this.hass,this._params.cardConfig.customize);if(t)await new Promise(i=>{const s={cancel:()=>i(!1),confirm:()=>i(!0),title:Zi("state_badge.default.error",this.hass),description:Ni("ui.panel.editor.validation_errors."+t,this.hass),primaryButtonLabel:Zi("ui.common.ok",this.hass)};$s(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return Ha})),dialogParams:s})});else if(this.schedule.schedule_id){const t=Re(await xs(this.hass,this.schedule.schedule_id),this.hass);if(pe(this.schedule,t))return void this.closeDialog();if(!t.enabled){await new Promise(t=>{const i={title:Ni("ui.dialog.enable_schedule.title",this.hass),description:Ni("ui.dialog.enable_schedule.description",this.hass),primaryButtonLabel:Zi("ui.common.yes",this.hass),secondaryButtonLabel:Zi("ui.common.no",this.hass),cancel:()=>{t(!1)},confirm:()=>{t(!0)}};$s(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return Ha})),dialogParams:i})})&&this.hass.callService("switch","turn_on",{entity_id:t.entity_id})}((e,t)=>{const i=da(t);return e.callApi("POST","scheduler/edit",i)})(this.hass,this.schedule).catch(e=>ma(e,this,this.hass)).then(()=>{this.closeDialog()})}else((e,t)=>{const i=da(t);return e.callApi("POST","scheduler/add",i)})(this.hass,this.schedule).catch(e=>ma(e,this,this.hass)).then(()=>{this.closeDialog()})}async _handleDeleteClick(e){await new Promise(t=>{const i={cancel:()=>t(!1),confirm:()=>t(!0),title:Ni("ui.dialog.confirm_delete.title",this.hass),description:Ni("ui.dialog.confirm_delete.description",this.hass),primaryButtonLabel:Zi("ui.common.ok",this.hass),secondaryButtonLabel:Zi("ui.common.cancel",this.hass)};$s(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return Ha})),dialogParams:i})}).then(e=>{var t,i;e&&(t=this.hass,i=this._params.editItem,t.callApi("POST","scheduler/remove",{schedule_id:i})).catch(e=>ma(e,this,this.hass)).then(()=>{this.closeDialog()})})}_setViewMode(e){let t=e.detail;const i=this.schedule.entries[this.selectedEntry].slots.filter(e=>e.actions.length).length>1;if(t!=_e.Scheme)if(t!=_e.Single||i)new Promise(t=>{const i={title:Ni("ui.dialog.confirm_migrate.title",this.hass),description:Ni("ui.dialog.confirm_migrate.description",this.hass),primaryButtonLabel:this.hass.localize("ui.common.yes"),secondaryButtonLabel:this.hass.localize("ui.common.no"),cancel:()=>{t(!1)},confirm:()=>{t(!0)}};$s(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return Ha})),dialogParams:i})}).then(e=>{e&&(this.schedule=(e=>{const t=e=>{let t=e.findIndex(e=>e.actions.length);t<0&&(t=Math.floor(e.length/2));let i=Object.assign(Object.assign({},e[t]),{stop:void 0});const s=i.conditions,a=i.start;return e=[{start:"00:00:00",stop:a,actions:[],conditions:s},i,{start:qe(Ce(Ee(a),{minutes:1})),stop:"00:00:00",actions:[],conditions:s}]};return e=Object.assign(Object.assign({},e),{entries:e.entries.map(e=>Object(Object.assign(Object.assign({},e),{slots:t(e.slots)})))})})(this.schedule),this.viewMode=t)});else{if(pe([...this.schedule.entries],[...Be.entries]))this.schedule=Object.assign(Object.assign({},this.schedule),{entries:[...We.entries]});else{let e=Object.assign(Object.assign({},this.schedule),{entries:this.schedule.entries.map(e=>{let t=e.slots.findIndex(e=>e.actions.length);return t<0&&(t=Math.floor(e.slots.length/2)),Object.assign(Object.assign({},e),{slots:e.slots.map((e,i)=>i==t?Object.assign(Object.assign({},e),{stop:void 0}):null).filter(Ze)})})});this.schedule=Re(e,this.hass)}this.viewMode=t}else{this.viewMode=t;pe([...this.schedule.entries],[...We.entries])&&(this.schedule=Object.assign(Object.assign({},this.schedule),{entries:[...Be.entries]}))}}};Fa.styles=oa,t([de({attribute:!1})],Fa.prototype,"hass",void 0),t([ce()],Fa.prototype,"_params",void 0),t([de({type:Boolean,reflect:!0})],Fa.prototype,"large",void 0),t([ce()],Fa.prototype,"schedule",void 0),t([ce()],Fa.prototype,"selectedEntry",void 0),t([ce()],Fa.prototype,"selectedSlot",void 0),t([ce()],Fa.prototype,"_panel",void 0),t([ce()],Fa.prototype,"_viewMode",void 0),Fa=t([re("dialog-scheduler-editor")],Fa);var Ua=Object.freeze({__proto__:null,get DialogSchedulerEditor(){return Fa}});
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */class Ba extends qs{constructor(e){if(super(e),this.et=V,e.type!==Is)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===V||null==e)return this.ft=void 0,this.et=e;if(e===R)return e;if("string"!=typeof e)throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.et)return this.ft;this.et=e;const t=[e];return t.raw=t,this.ft={_$litType$:this.constructor.resultType,strings:t,values:[]}}}Ba.directiveName="unsafeHTML",Ba.resultType=1;const Wa=Ns(Ba);var Za=window&&window.__assign||function(){return(Za=Object.assign||function(e){for(var t,i=1,s=arguments.length;i<s;i++)for(var a in t=arguments[i])Object.prototype.hasOwnProperty.call(t,a)&&(e[a]=t[a]);return e}).apply(this,arguments)};var Ka={second:45,minute:45,hour:22,day:5};const Ga=(e,t,i)=>{if(i===Me.am_pm||!i&&t.time_format===Me.am_pm){const t=Ie(e.getHours()).am_pm;return`${Ie(e.getHours()).hours}:${String(e.getMinutes()).padStart(2,"0")} ${t}`}return i===Me.twenty_four||!i&&t.time_format===Me.twenty_four?`${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}`:(()=>{try{(new Date).toLocaleTimeString("i")}catch(e){return"RangeError"===e.name}return!1})()?e.toLocaleTimeString(t.language,{hour:"numeric",minute:"2-digit",hour12:Le(t)}):Le(t)?Ga(e,t,Me.am_pm):Ga(e,t,Me.twenty_four)};let Ja=class extends oe{constructor(){super(...arguments),this.updateInterval=60,this.timer=0}startRefreshTimer(e){clearInterval(this.timer),this.timer=window.setInterval(()=>{this.requestUpdate()},1e3*e),this.updateInterval=e}set hass(e){this._hass=e,this.startRefreshTimer(this.updateInterval)}relativeTime(e){if(!this._hass)return"";const t=new Date;let i=(t.getTime()-e.getTime())/1e3;const s=i>=0?"past":"future";i=Math.abs(i);const a=Math.round(i);if("future"==s&&a>0){if(i/3600>=6){const i=t.setHours(0,0,0,0),s=Math.floor((e.valueOf()-i.valueOf())/864e5);let a="";s>14?a=function(e,t){const i=()=>{try{(new Date).toLocaleDateString("i")}catch(e){return"RangeError"===e.name}return!1},s=(e,t)=>{switch(t){case"year":return e.getFullYear();case"month":return Da[e.getMonth()];case"day":return e.getDate()}};return e.getFullYear()==(new Date).getFullYear()?i()?new Intl.DateTimeFormat(t.language,{month:"long",day:"numeric"}).format(e):`${s(e,"month")} ${s(e,"day")}`:i()?new Intl.DateTimeFormat(t.language,{year:"numeric",month:"long",day:"numeric"}).format(e):`${s(e,"month")} ${s(e,"day")}, ${s(e,"year")}`}(e,this._hass.locale):s>7?a=Ni("ui.components.date.next_week_day",this._hass,"{weekday}",_s(e,"long",this._hass)):1==s?a=Ni("ui.components.date.tomorrow",this._hass):s>0&&(a=_s(e,"long",this._hass));let o=Ni("ui.components.time.absolute",this._hass,"{time}",Ga(e,this._hass.locale));return 12==e.getHours()&&0==e.getMinutes()?o=Ni("ui.components.time.at_noon",this._hass):0==e.getHours()&&0==e.getMinutes()&&(o=Ni("ui.components.time.at_midnight",this._hass)),String(a+" "+o).trim()}if(Math.round(i/60)>60&&Math.round(i/60)<120){const e=Math.round(i/60-60),t=Zi("ui.common.and",this._hass);return`${new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(1,"hour")} ${t} ${Intl.NumberFormat(this._hass.locale.language,{style:"unit",unit:"minute",unitDisplay:"long"}).format(e)}`}if(Math.round(i)>60&&Math.round(i)<120){const e=Math.round(i-60),t=Zi("ui.common.and",this._hass);return`${new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(1,"minute")} ${t} ${Intl.NumberFormat(this._hass.locale.language,{style:"unit",unit:"second",unitDisplay:"long"}).format(e)}`}}const o=function(e,t,i){void 0===t&&(t=Date.now()),void 0===i&&(i={});var s=Za(Za({},Ka),i||{}),a=(+e-+t)/1e3;if(Math.abs(a)<s.second)return{value:Math.round(a),unit:"second"};var o=a/60;if(Math.abs(o)<s.minute)return{value:Math.round(o),unit:"minute"};var n=a/3600;if(Math.abs(n)<s.hour)return{value:Math.round(n),unit:"hour"};var r=a/86400;if(Math.abs(r)<s.day)return{value:Math.round(r),unit:"day"};var l=new Date(e),d=new Date(t),c=l.getFullYear()-d.getFullYear();if(Math.round(Math.abs(c))>0)return{value:Math.round(c),unit:"year"};var u=12*c+l.getMonth()-d.getMonth();if(Math.round(Math.abs(u))>0)return{value:Math.round(u),unit:"month"};var h=a/604800;return{value:Math.round(h),unit:"week"}}(e);return new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(o.value,o.unit)}render(){if(!this._hass||!this.datetime)return q``;const e=new Date,t=Math.round((this.datetime.valueOf()-e.valueOf())/1e3);let i=60;return Math.abs(t)<=150&&(i=Math.max(Math.ceil(Math.abs(t))/10,2)),this.updateInterval!=i&&this.startRefreshTimer(i),q`
      ${Wi(this.relativeTime(this.datetime))}
    `}};t([de()],Ja.prototype,"_hass",void 0),t([de()],Ja.prototype,"datetime",void 0),Ja=t([re("scheduler-relative-time")],Ja);let Ya=class extends oe{render(){var e,t,i,s,a;try{const o=this.hass.states[this.schedule.entity_id];if(!o)return q``;const n="off"==o.state,r=this.schedule.entries[0].slots[this.schedule.next_entries[0]||0].actions[0];let l=_a(r,this.config.customize);if("entity"==(null===(e=this.config.display_options)||void 0===e?void 0:e.icon)){let e=[(null===(t=r.target)||void 0===t?void 0:t.entity_id)||[]].flat().shift();["script","notify"].includes(Ri(r.service))&&(e=r.service),e&&(l=Ws(e,this.config.customize,this.hass))}const d=![(null===(i=r.target)||void 0===i?void 0:i.entity_id)||[]].flat().every(e=>Object.keys(this.hass.states).includes(e));return d&&(l="mdi:help"),q`
      <ha-icon
        icon="${l}"
      ...
      <div
        class="info ${n?"disabled":""} ${d?"defective":""}"
        @click=${this._handleItemClick}
      >
        ${this.renderDisplayItem((null===(s=this.config.display_options)||void 0===s?void 0:s.primary_info)||"default")}
        <div class="secondary">
        ${this.renderDisplayItem((null===(a=this.config.display_options)||void 0===a?void 0:a.secondary_info)||He)}
        </div>
      </div>
      <div class="state">
        <ha-entity-toggle
    ...
    `}catch(e){return q`
      ...
      `}}renderDisplayItem(e){const t=e=>{const t=e.split("<relative-time></relative-time>");if(t.length>1){const e=this.schedule.timestamps[this.schedule.next_entries[0]||0];return q`
        ...
        `}if(null!==e.match(/^(<tag>[^<]*<\/tag>)+$/)){let t=e.split(/<tag>([^<]*)<\/tag>/).filter(e=>e);return q`
          ...
          </div>`}return Wa(e)};return bs(this.schedule,e,this.hass,this.config.customize).filter(e=>e.length).map(e=>q`${t(e)}<br/>`)}_handleItemClick(e){const t=new CustomEvent("editClick",{detail:{schedule_id:this.schedule_id}});this.dispatchEvent(t)}_handleIconClick(e){const t=new CustomEvent("editClick",{detail:{schedule_id:this.schedule_id}});this.dispatchEvent(t)}static get styles(){return r`
      :host {
        display: flex;
        align-items: center;
        flex-direction: row;
    ...
    `}};t([de()],Ya.prototype,"hass",void 0),t([de()],Ya.prototype,"schedule_id",void 0),t([de()],Ya.prototype,"schedule",void 0),t([de()],Ya.prototype,"config",void 0),Ya=t([re("scheduler-item-row")],Ya),e.SchedulerCard=class extends oe{constructor(){super(...arguments),this._config={},this.showDiscovered=!1,this.translationsLoaded=!1,this.connectionError=!1}async setConfig(e){e=(e=>{let t=[];if(Ke(e,"include")&&!Xe(e.include)&&t.push("'include' must be a list of strings"),Ke(e,"exclude")&&!Xe(e.exclude)&&t.push("'exclude' must be a list of strings"),Ke(e,"discover_existing")&&!Ge(e.discover_existing)&&t.push("'discover_existing' must be a boolean"),!Ke(e,"title")||Ge(e.title)||Ye(e.title)||t.push("'title' must be a boolean or string"),Ke(e,"time_step")&&(!Je(e.time_step)||Number(e.time_step)<1||Number(e.time_step)>30)&&t.push("'time_step' must be a number between 1 and 30"),Ke(e,"show_header_toggle")&&!Ge(e.show_header_toggle)&&t.push("'show_header_toggle' must be a boolean"),Ke(e,"show_add_button")&&!Ge(e.show_add_button)&&t.push("'show_add_button' must be a boolean"),Ke(e,"display_options")&&(Qe(e.display_options)?(!Ke(e.display_options,"primary_info")||Ye(e.display_options.primary_info)||Xe(e.display_options.primary_info)||t.push("in 'display_options': 'primary_info' must be a string or list of strings"),!Ke(e.display_options,"secondary_info")||Ye(e.display_options.secondary_info)||Xe(e.display_options.secondary_info)||t.push("in 'display_options': 'secondary_info' must be a string or list of strings"),!Ke(e.display_options,"icon")||Ye(e.display_options.icon)&&["action","entity"].includes(e.display_options.icon)||t.push("in 'display_options': 'icon' must be a set to either 'action' or 'entity' ")):t.push("'display_options' must be a struct")),!Ke(e,"sort_by")||Ye(e.sort_by)||Xe(e.sort_by)||t.push("'sort_by' must be a string or list of strings"),Ke(e,"customize")&&!Qe(e.customize))t.push("'customize' must be a struct");else if(Ke(e,"customize")){let i=Object.entries(e.customize).map(([e,t])=>et(e,t)).filter(Ze);i.length&&t.push(...i)}if(!Ke(e,"tags")||Ye(e.tags)||Xe(e.tags)||t.push("'tags' must be a string or list of strings"),!Ke(e,"exclude_tags")||Ye(e.tags)||Xe(e.tags)||t.push("'exclude_tags' must be a string or list of strings"),t.length)throw new Error(`Invalid configuration provided (${t.length} error${t.length>1?"s":""}): ${t.join(", ")}.`);return e})(e),this._config=Object.assign({},e)}async firstUpdated(){await(async()=>{if(customElements.get("ha-checkbox")&&customElements.get("ha-slider")&&customElements.get("ha-combo-box"))return;await customElements.whenDefined("partial-panel-resolver");const e=document.createElement("partial-panel-resolver");e.hass={panels:[{url_path:"tmp",component_name:"config"}]},e._updateRoutes(),await e.routerOptions.routes.tmp.load(),await customElements.whenDefined("ha-panel-config");const t=document.createElement("ha-panel-config");await t.routerOptions.routes.automation.load()})();document.querySelector("home-assistant")._loadFragmentTranslations(this.hass.language,"config"),await js(this.hass).then(e=>{e=Object.fromEntries(Object.entries(e).filter(([e])=>Fi(e,this._config))),this._config=Object.assign(Object.assign({},this._config),{customize:Object.assign(Object.assign({},e),this._config.customize||{})})})}willUpdate(){this.hass.loadBackendTranslation("services")}__checkSubscribed(){void 0===this.__unsubs&&this.isConnected&&void 0!==this.hass&&(this.__unsubs=this.hassSubscribe())}connectedCallback(){super.connectedCallback(),this.__checkSubscribed()}disconnectedCallback(){if(super.disconnectedCallback(),this.__unsubs){for(;this.__unsubs.length;){const e=this.__unsubs.pop();e instanceof Promise?e.then(e=>e()):e()}this.__unsubs=void 0}}updated(e){super.updated(e),e.has("hass")&&this.__checkSubscribed()}hassSubscribe(){return this.loadSchedules(),[this.hass.connection.subscribeMessage(e=>this.handleScheduleItemUpdated(e),{type:"scheduler_updated"})]}shouldUpdate(e){const t=e.get("hass"),i=e.get("_config");if(i&&this._config){Object.keys(i).filter(e=>i[e]!==this._config[e]).some(e=>["tags","discover_existing","sort_by","display_options"].includes(e))&&(async()=>{await this.loadSchedules()})()}return!this.translationsLoaded&&Zi("component.input_boolean.services.turn_on.name",this.hass,!1).length&&Zi("ui.panel.config.automation.editor.conditions.type.sun.sunrise",this.hass,!1).length?(this.translationsLoaded=!0,!0):!t||1!=e.size||!this.schedules||Object.values(this.schedules).some(e=>JSON.stringify(t.states[e.entity_id])!==JSON.stringify(this.hass.states[e.entity_id]))}render(){let e=[...this.schedules||[]],t=e.filter(e=>Ui(e,this._config)),i=e.filter(e=>!Ui(e,this._config));const s=this.showDiscovered?e.some(e=>{var t;return["on","triggered"].includes((null===(t=this.hass.states[e.entity_id])||void 0===t?void 0:t.state)||"")}):t.some(e=>{var t;return["on","triggered"].includes((null===(t=this.hass.states[e.entity_id])||void 0===t?void 0:t.state)||"")});return q`
      <ha-card>
        <div class="card-header">
          <div class="name">
            ${!Ze(this._config.title)||"boolean"==typeof this._config.title&&this._config.title?Ni("ui.panel.common.title",this.hass):"boolean"==typeof this._config.title?"":this._config.title}
          </div>
    ...
    ${this.connectionError?q`
        <div>
          <hui-warning .hass=${this.hass}>
            <span style="white-space: normal">
              ${Ni("ui.panel.overview.backend_error",this.hass)}
            </span>
          </hui-warning>
        </div>
      `:Object.keys(e).length?t.map(e=>q`
          ...
          `):q`
        <div>
          ${Ni("ui.panel.overview.no_entries",this.hass)}
        </div>
        `}
      ...
      ${Object.keys(e).length>t.length&&!1!==this._config.discover_existing?this.showDiscovered?q`
          ...
          ${i.map(e=>q`
              ...
              <div>
                ...
                >
                  ${Ni("ui.panel.overview.hide_excluded",this.hass)}
                </ha-button>
              </div>
            `:q`
              <div>
                ...
                >
                  +
                  ${Ni("ui.panel.overview.excluded_items",this.hass,"{number}",Object.keys(e).length-t.length)}
                </ha-button>
              </div>
            `:""}
        </div>
    ...
    `}async loadSchedules(){Se(this.hass).then(e=>{this.schedules=ws(e,this._config,this.hass)}).catch(e=>{this.schedules=[],this.connectionError=!0})}async getCardSize(){return new Promise(e=>{let t=0;const i=setInterval(()=>{var s;if(t++,!this._config||!this.schedules&&!this.connectionError&&t<50)return;let a=this._config.title||this._config.show_header_toggle?3:1;this._config.show_add_button&&(a+=1);const o=(([(null===(s=this._config.display_options)||void 0===s?void 0:s.secondary_info)||[]].flat().length||2)+1)/2;this.schedules&&(a+=this.showDiscovered?Object.keys(this.schedules).length*o:Object.values(this.schedules).filter(e=>Ui(e,this._config)).length*o),clearInterval(i),e(Math.round(a))},50)})}_retryConnection(){setTimeout(async()=>{await this.loadSchedules()},100),this.connectionError=!1,this.requestUpdate()}async handleScheduleItemUpdated(e){"scheduler_item_removed"!=e.event?xs(this.hass,e.schedule_id).then(t=>{const i=this.schedules.findIndex(t=>t.schedule_id==e.schedule_id),s=i>=0?this.schedules[i]:null;let a=[...this.schedules||[]];!t||!1===this._config.discover_existing&&!Ui(t,this._config)?s&&(a=a.filter(t=>t.schedule_id!==e.schedule_id)):s?s.timestamps[s.next_entries[0]||0]==t.timestamps[t.next_entries[0]||0]?a=Object.assign(a,{[i]:t}):(a=Object.assign(a,{[i]:t}),a=ws(a,this._config,this.hass)):a=ws([...a,t],this._config,this.hass),this.schedules=[...a]}):this.schedules=(this.schedules||[]).filter(t=>t.schedule_id!==e.schedule_id)}_handleEditClick(e,t){if(!this.schedules)return;const i={schedule:Re(t,this.hass),cardConfig:this._config,editItem:t.schedule_id};$s(e.target,"show-dialog",{dialogTag:"dialog-scheduler-editor",dialogImport:()=>Promise.resolve().then((function(){return Ua})),dialogParams:i})}_addClick(e){const t=[this._config.tags||[]].flat().filter(e=>!["none","disabled","enabled"].includes(e));let i=this._config.default_editor==_e.Scheme?JSON.parse(JSON.stringify(Be)):JSON.parse(JSON.stringify(We));const s={schedule:Object.assign(Object.assign({},i),{tags:1==t.length?t:[]}),cardConfig:this._config};$s(this,"show-dialog",{dialogTag:"dialog-scheduler-editor",dialogImport:()=>Promise.resolve().then((function(){return Ua})),dialogParams:s})}toggleDisableAll(e){if(!this.hass||!this.schedules)return;const t=e.target.checked;Object.values(this.schedules).filter(e=>this.showDiscovered||Ui(e,this._config)).forEach(e=>{this.hass.callService("switch",t?"turn_on":"turn_off",{entity_id:e.entity_id})})}static getConfigElement(){return document.createElement("scheduler-card-editor")}},e.SchedulerCard.styles=r`
    .card-header {
      display: flex;
      justify-content: space-between;
    }
